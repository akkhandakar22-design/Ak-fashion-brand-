...
const translations: Record<'en' | 'bn', Record<string, string>> = {
  en: {
    ...
    'order_inquiries': 'Order Inquiries',
    'shipping_returns': 'Shipping & Returns',
    'authenticity_guarantee': 'Authenticity Guarantee',
    'contact_curator': 'Contact Curator',
  ...
  bn: {
    ...
    'order_inquiries': 'অর্ডার সংক্রান্ত জিজ্ঞাসা',
    'shipping_returns': 'শিপিং এবং রিটার্ন',
    'authenticity_guarantee': 'পণ্যের সত্যতা নিশ্চিতকরণ',
    'contact_curator': 'কিউরেটরের সাথে যোগাযোগ',
    'start_live_chat': 'লাইভ চ্যাট শুরু করুন',
